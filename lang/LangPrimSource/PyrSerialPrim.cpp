...
public:
		...
		m_port(ioService, serialport)
	{
		...
		case kNoParity:
			m_port.set_option(serial_port::parity(serial_port::parity::none)); break;

		case kEvenParity:
			m_port.set_option(serial_port::parity(serial_port::parity::even)); break;

		case kOddParity:
			m_port.set_option(serial_port::parity(serial_port::parity::odd)); break;
		}
